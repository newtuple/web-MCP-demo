  ...
  return (
    <>
      <section className="relative overflow-hidden min-h-screen bg-white">
        <div className="pointer-events-none absolute -top-24 left-[18%] h-72 w-72 rounded-full bg-[var(--accent-100)]/55 blur-3xl" />
          ...
          <FadeIn>
            <div className="max-w-5xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4 mb-5">
                ...
                <Button href="#our-values" variant="outline" size="lg" className="border-gray-300 text-gray-900 hover:text-white" fillClassName="bg-[var(--accent-900)]">
                  Explore values
                </Button>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
          <FadeIn>
            <article className="group relative h-full overflow-hidden rounded-3xl border border-gray-200/90 bg-white p-6 md:p-7 shadow-[0_20px_40px_-28px_rgba(15,23,42,0.3)]">
              ...
              <div className="flex h-11 w-11 items-center justify-center rounded-xl border border-[var(--accent-100)] bg-[var(--accent-50)] mb-4">
                <Flag className="h-5 w-5 text-[var(--accent-900)]" strokeWidth={1.6} />
              </div>
              <p className="text-[11px] uppercase tracking-[0.16em] text-[var(--accent-900)] font-semibold mb-2">Mission</p>
          ...
          <FadeIn delay={0.08}>
            <article className="group relative h-full overflow-hidden rounded-3xl border border-gray-200/90 bg-white p-6 md:p-7 shadow-[0_20px_40px_-28px_rgba(15,23,42,0.3)]">
              <div className="pointer-events-none absolute inset-x-0 top-0 h-[2px] bg-gradient-to-r from-transparent via-[var(--accent-400)] to-transparent -translate-x-[110%] transition-transform duration-700 group-hover:translate-x-0" />
              <div className="flex h-11 w-11 items-center justify-center rounded-xl border border-[var(--accent-100)] bg-[var(--accent-50)] mb-4">
                <Compass className="h-5 w-5 text-[var(--accent-900)]" strokeWidth={1.6} />
              </div>
              <p className="text-[11px] uppercase tracking-[0.16em] text-[var(--accent-900)] font-semibold mb-2">Vision</p>
      ...
      <Section className="py-14 md:py-16 bg-gray-50">
        <FadeIn>
          <div className="text-center mb-10 md:mb-12">
            <p className="text-[11px] uppercase tracking-[0.16em] text-[var(--accent-900)] font-semibold mb-2">Company Narrative</p>
            ...
            <FadeIn key={paragraph} delay={index * 0.08}>
              <article className="relative pl-12 md:pl-14 pb-7 md:pb-8 last:pb-0">
                {index < data.story.paragraphs.length - 1 && (
                  <div className="absolute left-[15px] top-8 h-[calc(100%+18px)] w-px bg-gradient-to-b from-[var(--accent-300)]/85 to-[var(--accent-200)]/45 md:left-[17px] md:h-[calc(100%+20px)]" />
                )}
                <div className="absolute left-0 top-0 flex h-8 w-8 items-center justify-center rounded-full border border-[var(--accent-100)] bg-[var(--accent-50)] text-[11px] font-semibold text-[var(--accent-900)] md:h-9 md:w-9">
                  {(index + 1).toString().padStart(2, '0')}
                </div>

                <article className="group relative overflow-hidden rounded-2xl border border-gray-200/90 bg-white px-5 py-4 md:px-6 md:py-5 shadow-[0_14px_26px_-22px_rgba(15,23,42,0.25)] transition-all duration-300 hover:border-[var(--accent-300)] hover:shadow-[0_22px_34px_-26px_rgba(0,71,171,0.35)]">
                  <div className="pointer-events-none absolute inset-x-0 top-0 h-[2px] bg-gradient-to-r from-transparent via-[var(--accent-400)] to-transparent -translate-x-[110%] transition-transform duration-700 group-hover:translate-x-0" />
      ...
      {data.howWeBuild && (
        <Section className="py-14 md:py-16 bg-white">
          <FadeIn>
            <div className="text-center mb-10 md:mb-12">
              <p className="text-[11px] uppercase tracking-[0.16em] text-[var(--accent-900)] font-semibold mb-2">Our Approach</p>
      ...
      <Section id="our-values" className="py-14 md:py-16 bg-white">
        <FadeIn>
          <div className="text-center mb-10 md:mb-12">
            <p className="text-[11px] uppercase tracking-[0.16em] text-[var(--accent-900)] font-semibold mb-2">Operating Principles</p>
              ...
              <article className="rounded-3xl border border-gray-200/90 bg-white shadow-[0_20px_40px_-28px_rgba(15,23,42,0.32)] overflow-hidden">
                <div className="border-b border-gray-200 bg-gradient-to-r from-[var(--accent-50)]/50 via-white to-cyan-50/35 p-5 md:p-6">
                  ...
                  <div className="flex items-center gap-3 mb-2.5">
                    <div className="h-10 w-10 rounded-xl border border-[var(--accent-100)] bg-[var(--accent-50)] flex items-center justify-center">
                      <selectedValue.icon className="h-5 w-5 text-[var(--accent-900)]" strokeWidth={1.5} />
                    </div>
                  ...
                  <StaggerChildren className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
                    {values.map((item, index) => (
                      <StaggerItem key={item.title}>
                        <article className="group relative overflow-hidden rounded-2xl border border-gray-200 bg-gray-50/70 p-4 transition-all duration-300 hover:border-[var(--accent-300)] hover:bg-white">
                          <div className="pointer-events-none absolute inset-x-0 top-0 h-[2px] bg-gradient-to-r from-transparent via-[var(--accent-400)] to-transparent -translate-x-[110%] transition-transform duration-700 group-hover:translate-x-0" />
                          <div className="flex items-start justify-between gap-2.5 mb-2.5">
                            <div className="h-9 w-9 rounded-lg border border-[var(--accent-100)] bg-[var(--accent-50)] flex items-center justify-center">
                              <item.icon className="h-4 w-4 text-[var(--accent-900)]" strokeWidth={1.5} />
                            </div>
      ...
      <Section className="py-14 md:py-16 bg-white">
        <FadeIn>
          <div className="text-center mb-10 md:mb-12">
            <p className="text-[11px] uppercase tracking-[0.16em] text-[var(--accent-900)] font-semibold mb-2">Core Capabilities</p>
        ...
        <StaggerChildren className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6">
          {expertise.map((item, index) => (
            <StaggerItem key={item.title}>
              <article className="group relative h-full min-h-[230px] overflow-hidden rounded-2xl border border-gray-200/90 bg-white p-5 md:p-6 shadow-[0_14px_28px_-22px_rgba(15,23,42,0.3)] transition-all duration-300 hover:-translate-y-1 hover:border-[var(--accent-300)] hover:shadow-[0_24px_42px_-26px_rgba(0,71,171,0.4)]">
                <div className="pointer-events-none absolute inset-x-0 top-0 h-[2px] bg-gradient-to-r from-transparent via-[var(--accent-400)] to-transparent -translate-x-[110%] transition-transform duration-700 group-hover:translate-x-0" />
