  ...
  return (
    <>
      <section className="relative overflow-hidden min-h-screen bg-white lg:flex lg:items-center">
        <div className="pointer-events-none absolute -top-24 left-[20%] h-72 w-72 rounded-full bg-cobalt-100/55 blur-3xl" />
          ...
          <FadeIn>
            <div className="max-w-5xl mx-auto text-center">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl leading-[1.04] tracking-tight text-gray-950 mb-6 font-light">
                ...
                <br />
                <span className="font-semibold text-cobalt-900">and acts on financial data</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4 mb-8">
                ...
                <Button href="#financial-use-cases" variant="outline" size="lg" className="border-gray-300 text-gray-900 hover:text-white" fillClassName="bg-cobalt-900">
                  Explore use cases
                </Button>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.08fr_0.92fr] gap-6 md:gap-8">
          <FadeIn delay={0.05}>
            <article className="group relative h-full overflow-hidden rounded-3xl border border-gray-200/90 bg-white p-5 md:p-6 shadow-[0_20px_40px_-28px_rgba(15,23,42,0.3)]">
              ...
              <span className="inline-flex items-center rounded-full border border-cobalt-100 bg-cobalt-50/80 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.12em] text-cobalt-900 mb-4">
                {data.caseStudy.badge}
              </span>
              <div className="space-y-3.5">
                {data.caseStudy.bullets.map((bullet) => (
                  <div key={bullet} className="flex items-start gap-2.5">
                    <CheckCircle2 className="h-4.5 w-4.5 text-cobalt-900 mt-0.5 flex-shrink-0" strokeWidth={1.6} />
          ...
          <FadeIn delay={0.1}>
            <article className="group relative h-full overflow-hidden rounded-3xl border border-gray-200/90 bg-white p-5 md:p-6 shadow-[0_20px_40px_-28px_rgba(15,23,42,0.3)]">
              ...
              <div className="flex h-11 w-11 items-center justify-center rounded-xl border border-cobalt-100 bg-cobalt-50 mb-4">
                <FileText className="h-5 w-5 text-cobalt-900" strokeWidth={1.6} />
              </div>
        ...
        <StaggerChildren className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
          {useCases.map((item, index) => (
            <StaggerItem key={item.title}>
              <article className="group relative h-full min-h-[250px] overflow-hidden rounded-2xl border border-gray-200/90 bg-white p-5 md:p-6 shadow-[0_14px_28px_-22px_rgba(15,23,42,0.3)] transition-all duration-300 hover:-translate-y-1 hover:border-cobalt-300 hover:shadow-[0_24px_42px_-26px_rgba(0,71,171,0.4)]">
                <div className="pointer-events-none absolute inset-x-0 top-0 h-[2px] bg-gradient-to-r from-transparent via-cobalt-400 to-transparent -translate-x-[110%] transition-transform duration-700 group-hover:translate-x-0" />
