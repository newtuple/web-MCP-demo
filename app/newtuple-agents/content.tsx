    ...
    <div className="relative mx-auto w-full max-w-[560px] px-1">
      ...
      <div className="group relative aspect-[4/3] sm:aspect-[16/11] overflow-hidden rounded-3xl border border-cobalt-100/90 bg-white/80 p-4 sm:p-5 md:p-6 shadow-[0_32px_68px_-42px_rgba(0,71,171,0.55)] backdrop-blur-sm">
        ...
        <div className="relative z-10 flex h-full flex-col">
          ...
          <div className="absolute left-[6%] top-[23%] hidden lg:block rounded-xl border border-cobalt-100 bg-white/90 px-3 py-2 text-[11px] font-medium text-gray-700 shadow-[0_10px_24px_-18px_rgba(0,71,171,0.55)] animate-float">
            Intake Agent
          </div>
...
export default function NewtupleAgentsContent({ data }: { data: NewtupleAgentsData }) {
  ...
  return (
    <>
      ...
      <Section className="bg-gray-50 py-14 md:py-16">
        ...
        <div className="flex gap-4 overflow-x-auto snap-x snap-mandatory scrollbar-hide -mx-2 px-2 py-2 md:mx-0 md:px-0 md:py-0 md:overflow-visible md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-6">
          {agentTypes.items.map((item) => (
            <Card
              key={item.title}
              className="min-w-[86%] sm:min-w-[70%] md:min-w-0 snap-start group relative overflow-hidden p-0 h-[300px] md:h-[318px] flex flex-col border border-gray-200/90 transition-all duration-300 hover:border-cobalt-300 hover:shadow-[0_24px_42px_-28px_rgba(0,71,171,0.42)]"
            >
              <div className="pointer-events-none absolute inset-x-0 top-0 h-[2px] bg-gradient-to-r from-transparent via-cobalt-400 to-transparent -translate-x-[110%] transition-transform duration-700 group-hover:translate-x-0" />
        ...
        <StaggerChildren className="flex gap-4 overflow-x-auto snap-x snap-mandatory scrollbar-hide -mx-2 px-2 py-2 md:mx-0 md:px-0 md:py-0 md:overflow-visible md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-6">
          {differentiatorFeatures.map((feature, index) => (
            <StaggerItem key={feature.title} className="min-w-[84%] sm:min-w-[62%] md:min-w-0 snap-start">
              <article className="group relative h-full min-h-[250px] overflow-hidden rounded-2xl border border-gray-200/90 bg-white p-5 md:p-6 shadow-[0_14px_28px_-22px_rgba(15,23,42,0.32)] transition-all duration-300 md:hover:-translate-y-1 hover:border-cobalt-300 hover:shadow-[0_24px_42px_-26px_rgba(0,71,171,0.4)]">
                <div className="pointer-events-none absolute inset-x-0 top-0 h-[2px] bg-gradient-to-r from-transparent via-cobalt-400 to-transparent -translate-x-[110%] transition-transform duration-700 group-hover:translate-x-0" />
                <div className="flex items-start justify-between gap-3 mb-5">
                  <div className="flex h-12 w-12 items-center justify-center rounded-xl border border-cobalt-100 bg-cobalt-50 transition-colors duration-300 group-hover:bg-cobalt-100">
                    <feature.icon className="h-6 w-6 text-cobalt-900" strokeWidth={1.5} />
                  </div>
            ...
            return (
              <StaggerItem key={item.title}>
                <a href={item.href} className="group block h-full">
                  <article className="relative h-full overflow-hidden rounded-3xl border border-gray-200/90 bg-white shadow-[0_16px_34px_-24px_rgba(15,23,42,0.35)] transition-all duration-300 ease-out hover:-translate-y-1.5 hover:border-cobalt-300 hover:shadow-[0_28px_52px_-26px_rgba(0,71,171,0.4)]">
                        ...
                        <div className="flex items-start justify-between gap-4">
                          <div className="w-12 h-12 rounded-xl bg-cobalt-50 flex items-center justify-center transition-all duration-300 group-hover:bg-white group-hover:shadow-[0_14px_26px_-18px_rgba(0,71,171,0.45)]">
                            {isDialogtuple ? (
                              ...
                              <Icon className="w-6 h-6 text-cobalt-900 transition-colors duration-300 group-hover:text-cyan-600" strokeWidth={1.5} />
                            )}
                          </div>
                        ...
                        <ul className="space-y-2.5">
                          {item.highlights.map((h) => (
                            <li key={h} className="flex items-start gap-2.5 text-sm text-gray-700">
                              <CheckCircle2 className="w-4 h-4 text-cobalt-900 mt-0.5 flex-shrink-0" strokeWidth={1.5} />
                              <span>{h}</span>
                            </li>
                          ))}
                        </ul>
      ...
      {/* Why Newtuple */}
      <Section className="bg-gradient-to-b from-white via-cobalt-50/25 to-white">
        <FadeIn>
          <div className="text-center mb-10 md:mb-12">
            <p className="text-[11px] uppercase tracking-[0.16em] text-cobalt-900 font-semibold mb-2">
              Why Teams Choose Us
        ...
        <FadeIn delay={0.05}>
          <div className="mb-8 md:mb-10 grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4">
            {stats.slice(0, 3).map((stat) => (
              <div
                key={stat.label}
                className="rounded-xl border border-cobalt-100/90 bg-white/90 px-4 py-3 text-center shadow-[0_14px_28px_-24px_rgba(0,71,171,0.35)]"
              >
                <p className="text-2xl font-semibold leading-tight text-cobalt-900">{stat.value}</p>
