    ...
    <div className="relative mx-auto w-full max-w-[560px] px-1">
      ...
      <div className="group relative aspect-[4/3] sm:aspect-[16/11] overflow-hidden rounded-3xl border border-[var(--accent-100)]/90 bg-white/80 p-4 sm:p-5 md:p-6 shadow-[0_32px_68px_-42px_rgba(0,71,171,0.55)] backdrop-blur-sm">
        ...
        <div className="relative z-10 flex h-full flex-col">
          ...
          <div className="absolute left-[7%] top-[22%] hidden lg:block rounded-xl border border-[var(--accent-100)] bg-white/90 px-3 py-2 text-[11px] font-medium text-gray-700 shadow-[0_10px_24px_-18px_rgba(0,71,171,0.55)] animate-float">
            Strategy Sprint
          </div>
        ...
        <StaggerChildren className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
          {whatWeOffer.items.map((item) => (
            <StaggerItem key={item.title}>
              <Card className="group relative overflow-hidden p-0 h-[350px] md:h-[318px] flex flex-col border border-gray-200/90 transition-all duration-300 hover:border-[var(--accent-300)] hover:shadow-[0_24px_42px_-28px_rgba(0,71,171,0.42)]">
        ...
        <StaggerChildren className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {phaseItems.map((phase: any, index: number) => (
            <StaggerItem key={phase.title}>
              <article className="group relative h-full min-h-[250px] overflow-hidden rounded-2xl border border-gray-200/90 bg-white p-6 shadow-[0_14px_28px_-22px_rgba(15,23,42,0.32)] transition-all duration-300 hover:-translate-y-1 hover:border-[var(--accent-300)] hover:shadow-[0_24px_42px_-26px_rgba(0,71,171,0.4)]">
                <div className="pointer-events-none absolute inset-x-0 top-0 h-[2px] bg-gradient-to-r from-transparent via-[var(--accent-400)] to-transparent -translate-x-[110%] transition-transform duration-700 group-hover:translate-x-0" />
                <div className="flex items-start justify-between gap-3 mb-4">
                  <div className="flex h-12 w-12 items-center justify-center rounded-xl border border-[var(--accent-100)] bg-[var(--accent-50)] transition-colors duration-300 group-hover:bg-[var(--accent-100)]">
                    <phase.icon className="w-6 h-6 text-[var(--accent-900)]" strokeWidth={1.5} />
                  </div>
                ...
                <span className="text-6xl font-bold text-[var(--accent-50)]/70 absolute bottom-4 right-4 select-none">
                  {phase.step}
                </span>
              </article>
            </StaggerItem>
            ...
            <StaggerItem key={feature.title}>
              <article className="group relative h-full min-h-[250px] overflow-hidden rounded-2xl border border-gray-200/90 bg-white p-5 md:p-6 shadow-[0_14px_28px_-22px_rgba(15,23,42,0.32)] transition-all duration-300 hover:-translate-y-1 hover:border-[var(--accent-300)] hover:shadow-[0_24px_42px_-26px_rgba(0,71,171,0.4)]">
                ...
                <div className="flex items-start justify-between gap-3 mb-5">
                  <div className="flex h-12 w-12 items-center justify-center rounded-xl border border-[var(--accent-100)] bg-[var(--accent-50)] transition-colors duration-300 group-hover:bg-[var(--accent-100)]">
                    <feature.icon
                      className="w-6 h-6 text-[var(--accent-900)]"
                      strokeWidth={1.5}
                    />
                  </div>
                  <span className="text-[11px] font-semibold tracking-[0.14em] text-gray-400">
        ...
        <Container className="relative z-10">
          ...
          <FadeIn delay={0.1}>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4 mb-8">
              {stats.slice(0, 3).map((stat) => (
                ...
                >
                  <p className="text-2xl font-semibold leading-tight text-[var(--accent-300)]">{stat.value}</p>
          ...
          <FadeIn delay={0.2}>
            <div className="max-w-3xl mx-auto rounded-2xl border border-gray-800 bg-gray-900/90 p-6 md:p-7 shadow-[0_24px_44px_-30px_rgba(0,0,0,0.8)]">
              <CheckCircle2 className="w-8 h-8 text-[var(--accent-300)] mb-3 mx-auto" strokeWidth={1.5} />
