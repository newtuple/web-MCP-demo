  ...
  return (
    <>
      <section className="relative overflow-hidden min-h-screen bg-white lg:flex lg:items-center">
        <div className="pointer-events-none absolute -top-24 left-[18%] h-96 w-96 rounded-full bg-cobalt-100/40 blur-3xl" />
          ...
          <FadeIn>
            <div className="max-w-5xl mx-auto text-center">
              <span className="inline-flex items-center gap-2 rounded-full border border-cobalt-100 bg-cobalt-50/80 px-4 py-1.5 text-[11px] font-semibold uppercase tracking-[0.14em] text-cobalt-900 mb-7">
                <Briefcase className="h-3.5 w-3.5 text-cobalt-900" />
                {data.hero.badge}
              </span>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl leading-[1.08] tracking-tight text-gray-950 mb-6 font-light">
                ...
                <span className="bg-gradient-to-r from-cobalt-900 to-cyan-600 bg-clip-text text-transparent font-semibold">
              ...
              <div className="flex justify-center mb-12">
                <Button href="/contactus" size="lg" className="bg-gray-950 text-white hover:text-white shadow-premium hover:shadow-premium-lg" fillClassName="bg-cobalt-900">
              ...
              <StaggerChildren className="grid grid-cols-1 md:grid-cols-3 gap-3.5 max-w-4xl mx-auto">
                {data.hero.outcomes.map((outcome) => (
                  <StaggerItem key={outcome}>
                    <div className="rounded-2xl border border-gray-200/80 bg-white/60 px-5 py-4 text-sm text-gray-700 font-medium shadow-[0_8px_30px_rgb(0,0,0,0.02)] backdrop-blur-sm transition-all duration-300 hover:border-cobalt-200 hover:bg-white hover:shadow-premium-sm">
                      {outcome}
                    </div>
                  </StaggerItem>
                ))}
      ...
      <Section className="py-14 md:py-20 bg-white relative overflow-hidden">
        ...
        <FadeIn>
          <div className="relative z-10 max-w-5xl mb-10">
            <span className="inline-flex items-center gap-2 rounded-full border border-cobalt-100 bg-white px-3.5 py-1.5 text-[10px] font-semibold uppercase tracking-[0.14em] text-cobalt-900 mb-5">
              <span className="h-2 w-2 rounded-full bg-cobalt-900" />
            ...
            return (
              <StaggerItem key={item.title}>
                <article className="h-full rounded-[1.6rem] border border-gray-200 bg-white p-5 md:p-6 shadow-[0_18px_36px_-30px_rgba(15,23,42,0.14)]">
                  <div className="inline-flex h-11 w-11 items-center justify-center rounded-xl bg-cobalt-50 text-cobalt-900 mb-6">
                  ...
                  <p className="text-[10px] uppercase tracking-[0.16em] text-cobalt-700 font-semibold mb-5">
                    {item.label}
                  </p>
                  ...
                  <ul className="space-y-3.5 mb-6">
                    {item.bullets.map((bullet) => (
                      <li key={bullet} className="flex items-start gap-3 text-[15px] text-gray-600 font-light leading-relaxed">
                        <Check className="h-4.5 w-4.5 text-cobalt-700 mt-0.5 flex-shrink-0" strokeWidth={2.4} />
                        <span>{bullet}</span>
                      </li>
                    ))}
                  </ul>

                  <div className="rounded-[1.25rem] bg-cobalt-900 px-4 py-4 md:px-5 md:py-5 text-white">
                    <p className="text-[10px] uppercase tracking-[0.16em] text-cobalt-100/85 font-semibold mb-2">
                      Value Example
                    </p>
      ...
      <Section className="py-16 md:py-24 bg-gray-950 relative overflow-hidden" id="challenges">
        ...
        <FadeIn>
          <div className="relative z-10 max-w-3xl mb-12">
            <p className="text-[11px] uppercase tracking-[0.16em] text-cobalt-300 font-semibold mb-3">
        ...
        <StaggerChildren className="relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {data.outcomes.items.map((item) => (
            <StaggerItem key={item.rank}>
              <article className="group relative h-full overflow-hidden rounded-2xl border border-gray-800/90 bg-gray-900/90 p-6 shadow-[0_24px_44px_-30px_rgba(0,0,0,0.85)] transition-all duration-300 hover:-translate-y-1 hover:border-cobalt-400/50 hover:shadow-[0_30px_54px_-30px_rgba(0,71,171,0.5)]">
              ...
              {data.agents.items.map((item, index) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full rounded-2xl border px-5 py-4 text-left transition-all duration-300 flex items-center gap-4 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cobalt-400/60 ${
                      isActive
                        ? 'border-cobalt-200 bg-cobalt-50/50 shadow-premium-sm'
                  ...
                  >
                    <div
                      className={`h-10 w-10 rounded-xl flex items-center justify-center transition-colors duration-300 ${
                        isActive
                          ? 'bg-white border border-cobalt-100 shadow-sm text-cobalt-900'
          ...
          {selectedAgent && (
            <FadeIn key={selectedAgent.id} delay={0.1} direction="none" className="min-w-0">
              <article className="rounded-3xl border border-gray-200 bg-white shadow-premium-lg overflow-hidden">
                <div className="border-b border-gray-200 bg-gradient-to-r from-cobalt-50/40 via-white to-cyan-50/20 p-6 md:p-8">
                  <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
                    <span className="inline-flex items-center gap-1.5 rounded-full border border-cobalt-100 bg-white px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.12em] text-cobalt-900 shadow-sm">
                      <Radio className="h-3.5 w-3.5 text-cobalt-900" />
                      Active Agent Solution
                    </span>
                    {selectedAgent.tabSublabel === 'Flagship' ? (
                      <span className="inline-flex items-center gap-1.5 text-[11px] text-cobalt-900 font-semibold bg-cobalt-50 border border-cobalt-100 px-3 py-1 rounded-full">
                        <span className="h-1.5 w-1.5 rounded-full bg-cobalt-500 animate-pulse" />
                          ...
                          {selectedAgent.pillars.map((pillar) => (
                            ...
                            >
                              <h4 className="text-sm font-semibold text-gray-950 mb-3 flex items-center gap-2">
                                <span className="h-1.5 w-1.5 rounded-full bg-cobalt-900" />
                                {pillar.title}
                              </h4>
                              <ul className="space-y-2">
                                {pillar.bullets.map((bullet) => (
                                  <li key={bullet} className="flex items-start gap-2 text-xs md:text-sm text-gray-600 font-light">
                                    <Check className="h-4 w-4 text-cobalt-600 mt-0.5 flex-shrink-0" strokeWidth={2} />
                                    <span>{bullet}</span>
                                  </li>
                                ))}
                              </ul>
                    ...
                    {!selectedAgent.pillars && selectedAgent.details && (
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        {selectedAgent.details.map((detail) => (
                          ...
                          >
                            <div>
                              <strong className="text-[10px] font-semibold tracking-wider text-cobalt-900 uppercase mb-2 block">
                                {detail.label}
                              </strong>
      ...
      <Section className="py-16 md:py-20 bg-gray-50/30 border-y border-gray-100">
        <FadeIn>
          <div className="max-w-4xl mx-auto text-center px-4">
            ...
            <p className="text-xs md:text-sm text-cobalt-900 font-semibold uppercase tracking-widest">
