          ...
          <FadeIn>
            <div className="max-w-5xl mx-auto text-center">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl leading-[1.04] tracking-tight text-gray-950 mb-6 font-light">
                AI built for
                <br />
                <span className="font-semibold text-[var(--accent-900)]">sensitive environments</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4 mb-8">
                ...
                <Button href="#care-pathways" variant="outline" size="lg" className="border-gray-300 text-gray-900 hover:text-white" fillClassName="bg-[var(--accent-900)]">
                  Explore pathways
                </Button>
              </div>
            ...
            <FadeIn delay={0.1}>
              <article className="group relative h-full overflow-hidden rounded-3xl border border-gray-800/90 bg-gray-900/90 p-5 md:p-6 shadow-[0_20px_40px_-28px_rgba(0,0,0,0.65)]">
                ...
                <div className="flex h-11 w-11 items-center justify-center rounded-xl border border-[var(--accent-500)]/35 bg-[var(--accent-500)]/15 mb-4">
                  <FileText className="h-5 w-5 text-[var(--accent-300)]" strokeWidth={1.6} />
                </div>
              ...
              <button
                ...
                className={`rounded-full border px-3 py-1.5 text-xs font-medium transition-all duration-250 ${
                  activeUseCase === index
                    ...
                    : 'border-gray-200 bg-white text-gray-600 hover:border-[var(--accent-200)] hover:text-gray-900'
                }`}
              >
                {item.title}
              </button>
