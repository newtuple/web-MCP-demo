        ...
        <div className="relative z-10 flex h-full flex-col">
          ...
          <div className="mt-3 rounded-2xl border border-gray-200 bg-white/95 p-3 sm:p-4">
            <div className="mb-2 flex items-center justify-between">
              <span className="text-[10px] font-semibold uppercase tracking-[0.12em] text-[var(--accent-900)]">Signal activity</span>
    ...
    <>
      <Hero
        ...
        title={
          <>
            ...
            <span className="mt-2 block text-[var(--accent-900)] font-semibold tracking-tight">Production voice AI, simplified</span>
          </>
        }
      ...
      >
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <Button href="#voice-capabilities" variant="outline" size="lg" className="border-gray-300 text-gray-900 hover:text-white" fillClassName="bg-[var(--accent-900)]">
              ...
              <article className="group relative h-full overflow-hidden rounded-2xl border border-gray-200/90 bg-white p-5 md:p-6 shadow-[0_14px_28px_-22px_rgba(15,23,42,0.3)] transition-all duration-300 hover:border-[var(--accent-300)] hover:shadow-[0_24px_42px_-26px_rgba(0,71,171,0.38)]">
                ...
                <div className="mb-4 flex items-center gap-3">
                  <div className="h-10 w-10 rounded-xl border border-[var(--accent-100)] bg-[var(--accent-50)] flex items-center justify-center">
                    <group.icon className="h-5 w-5 text-[var(--accent-900)]" strokeWidth={1.5} />
                  </div>
                ...
                <div className="flex flex-wrap gap-2.5">
                  {group.items.map((provider) => (
                    <span
                      key={provider}
                      className="rounded-full border border-gray-200 bg-gray-50 px-3 py-1.5 text-xs font-medium text-gray-700 transition-colors duration-250 group-hover:border-[var(--accent-100)] group-hover:bg-[var(--accent-50)]/45"
                    >
                      {provider}
                    </span>
                  ))}
